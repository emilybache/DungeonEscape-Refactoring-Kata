...
void hide() {
    char* scenario = "You are hiding in the guardroom. Slowly the screams get quieter. However you realize the room was not empty after all. A guard appears and captures you. Soon you find yourself back in your cell, feeling miserable that your escape attempt failed.\n";
    printf("%s", scenario);
    play_again();
}
...
void upstairs() {
    printf("The stairs lead to the dungeon exit. Your friend Freja the Magnificent Warrior runs towards you and embraces you. 'I am here to rescue you!' she says.\nCongratulations! You have won!!\n\n");
    play_again();
}
